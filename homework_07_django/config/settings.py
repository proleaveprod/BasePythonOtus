...
INSTALLED_APPS = [
    ...
    'django.contrib.sessions',      # - сеансы
    'django.contrib.messages',      # - обмен сообщениями
    'django.contrib.staticfiles',   # - статические файлы
    
    'blog_app', # Вот сюда добавили свое приложение
]
...
TIME_ZONE = 'Europe/Moscow' # Таймзону я поменял
